...
const EditEducationForm = () => {
    ...
    const getCandidateInfo = async () => {
        ...
        setCertificate(docSnap.data()?.education[itemPosition].certificate)
        setSchool(docSnap.data()?.education[itemPosition].school)
        setDuration(docSnap.data()?.education[itemPosition].duration)
        setIsLoading(false)
    }
                ...
                isLoading
                    ...
                    : <div
                        ...
                        <div className='relative bg-slate-800 my-auto p-8 max-w-[400px] min-w-[300px] mx-auto rounded shadow-lg'>
                            ...
                            <form className=''>
                                <h3 className='text-white font-bold text-xl my-3 sm:text-center text-left'>Edit Education</h3>
